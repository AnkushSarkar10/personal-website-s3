...
<template>
  <div class="relative flex flex-col min-h-dvh overflow-hidden bg-bg text-text font-ubuntu antialiased">
    ...
    <a
      ...
      class="fixed top-5 right-5 z-20 text-text-secondary hover:text-accent transition-colors"
      title="GitHub"
    >
      <svg class="w-7 h-7 md:w-8 md:h-8 transition-transform hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
